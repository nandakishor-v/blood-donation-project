...
public class Recpa extends AppCompatActivity {
    private TextView bt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recpa);
        bt=findViewById(R.id.LogB);
        bt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i=new Intent(Recpa.this,login.class);
                startActivity(i);
            }
        ...
        rbt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(Recpa.this,"Select Your Blood Group",Toast.LENGTH_SHORT).show();
                    return ;
                }
                else{
                    ...
                    mauth.createUserWithEmailAndPassword(email,pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            {String error=task.getException().toString();
                                Toast.makeText(Recpa.this,"error"+error,Toast.LENGTH_SHORT).show();
                                ...
                                userinfo.put("search","Receiver"+bgp);
                                usdbrf.updateChildren(userinfo).addOnCompleteListener(new OnCompleteListener() {
                                    @Override
                                    public void onComplete(@NonNull Task task) {
                                        if(task.isSuccessful())
                                        {
                                            Toast.makeText(Recpa.this,"Data Added",Toast.LENGTH_SHORT).show();
                                        }
                                        else {

                                            Toast.makeText(Recpa.this,task.getException().toString(),Toast.LENGTH_SHORT).show();
                                        }
                                        finish();
                                        //ldr.dismiss();
                                    }
                                ...
                                {final StorageReference flpth= FirebaseStorage.getInstance().getReference().child("profile images").child(cusid);
                                    ...
                                    uploadTask.addOnFailureListener(new OnFailureListener() {
                                        ...
                                        public void onFailure(@NonNull Exception e) {
                                            Toast.makeText(Recpa.this,"Image Upload Failed",Toast.LENGTH_SHORT).show();
                                        }
                                    });
                                                ...
                                                result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                    ...
                                                    public void onSuccess(Uri uri) {
                                                        ...
                                                        usdbrf.updateChildren(newImagemap).addOnCompleteListener(new OnCompleteListener() {
                                                            ...
                                                            public void onComplete(@NonNull Task task) {
                                                                if(task.isSuccessful())
                                                                {Toast.makeText(Recpa.this,"Image Url added to database",Toast.LENGTH_SHORT).show();
                                    ...
                                    Intent i=new Intent(Recpa.this,MainActivity.class);
                                    startActivity(i);
                                    finish();
                                    ldr.dismiss();
                                }
